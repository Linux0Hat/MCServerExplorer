...
def ping_server(port):
    ...
    if  status:
        ...
        print(f"{colorama.Fore.RED}{players:10}{colorama.Fore.BLUE}{ip:22}{colorama.Fore.LIGHTYELLOW_EX}{version:30}{colorama.Fore.LIGHTGREEN_EX}{latency:6}{colorama.Style.RESET_ALL}{description}{colorama.Style.RESET_ALL}")
